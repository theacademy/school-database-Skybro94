...
public class SchoolDaoImpl implements SchoolDao {
    ...
    * Do not change any code outside of the placeholders provided.
    ...
    public List<StudentClassCount> studentsPerClass() {
        ...
        String sql = "SELECT course.courseCode, course.courseDesc, COUNT(course_student.student_id) AS numStudents " +
                "FROM course JOIN course_student ON course.cid = course_student.course_id GROUP BY course.courseCode, course.courseDesc";
    ...
    public void addStudentToClass() {
        ...
        String sql = "INSERT INTO course_student (student_id, course_id) SELECT 123, cid FROM course WHERE courseCode = 'CS148'";
